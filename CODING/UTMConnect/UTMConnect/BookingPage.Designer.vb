...
Partial Class BookingPage
    ...
    Private Sub InitializeComponent()
        Dim ServiceTotalPrice As Label
        Label23 = New Label()
        Label22 = New Label()
        Label21 = New Label()
        Label20 = New Label()
        ...
        ServiceQuantity = New Label()
        Label13 = New Label()
        Label14 = New Label()
        SellerContNum = New Label()
        Label15 = New Label()
        ServiceTotalPrice = New Label()
        ...
        ' ServiceTotalPrice
        ' 
        ServiceTotalPrice.BackColor = Color.Indigo
        ServiceTotalPrice.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ServiceTotalPrice.ForeColor = SystemColors.ControlLightLight
        ServiceTotalPrice.Location = New Point(679, 476)
        ServiceTotalPrice.Name = "ServiceTotalPrice"
        ServiceTotalPrice.Size = New Size(57, 17)
        ServiceTotalPrice.TabIndex = 133
        ServiceTotalPrice.Text = "8.00"
        ServiceTotalPrice.TextAlign = ContentAlignment.TopRight
        ' 
        ' Label23
        ' 
        ...
        Label7.Location = New Point(60, 549)
        Label7.Name = "Label7"
        Label7.Size = New Size(421, 147)
        Label7.TabIndex = 123
        ' 
        ' ServiceDetails
        ' 
        ...
        ServiceDetails.Size = New Size(252, 404)
        ...
        RegisterButton.Font = New Font("Arial", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        RegisterButton.ForeColor = Color.Black
        RegisterButton.ImageAlign = ContentAlignment.TopCenter
        RegisterButton.Location = New Point(533, 514)
        RegisterButton.Margin = New Padding(0)
        RegisterButton.Name = "RegisterButton"
        RegisterButton.Size = New Size(209, 34)
        RegisterButton.TabIndex = 125
        RegisterButton.Text = "Purchase"
        ...
        ServicePrice.Location = New Point(704, 378)
        ServicePrice.Name = "ServicePrice"
        ServicePrice.Size = New Size(38, 17)
        ...
        ' ServiceQuantity
        ' 
        ServiceQuantity.BackColor = Color.Indigo
        ServiceQuantity.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ServiceQuantity.ForeColor = SystemColors.ControlLightLight
        ServiceQuantity.Location = New Point(679, 406)
        ServiceQuantity.Name = "ServiceQuantity"
        ServiceQuantity.Size = New Size(57, 17)
        ServiceQuantity.TabIndex = 132
        ServiceQuantity.Text = "2"
        ServiceQuantity.TextAlign = ContentAlignment.TopRight
        ' 
        ' Label13
        ' 
        ...
        Label14.Location = New Point(639, 378)
        ...
        SellerContNum.Location = New Point(639, 258)
        SellerContNum.Name = "SellerContNum"
        SellerContNum.Size = New Size(95, 21)
        ...
        Controls.Add(ServiceTotalPrice)
        Controls.Add(ServiceQuantity)
    ...
    Friend WithEvents ServiceQuantity As Label
